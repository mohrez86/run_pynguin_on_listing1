...
def DenseNet(
        ...
        dense_blocks: int = 3,
        # dense_layers=-1,
        dense_layers: Union[int, List[int]] = -1,
        # growth_rate=12,
        growth_rate: int = 12,
        # nb_classes=None,
        nb_classes: int = None,
    ...
    if type(dense_layers) is list:
        ...
        dense_layers = (depth - 4) / 3  # bug1
        # dense_layers = int((depth - 4) / 3)  # patch for bug1
        if bottleneck:
            # dense_layers = dense_layers / 2  # commented by MohRez
            dense_layers = int(dense_layers / 2)  # added by MohRez
